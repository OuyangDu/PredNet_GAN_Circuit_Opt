...
ERROR_TOL = 1e-10
FIGURE_DIR = '/storage1/fs1/ralfwessel/Active/border_ownership/figure/'
DATA_DIR_HOME = '/storage1/fs1/ralfwessel/Active/border_ownership/'
DATA_DIR = '/storage1/fs1/ralfwessel/Active/border_ownership/test/data/'
KITTI_DATA_DIR = '/storage1/fs1/ralfwessel/Active/border_ownership/kitti/'
...
WEIGHTS_DIR = os.path.join(DATA_DIR_HOME, 'model_data_keras2/')

# Where results (prediction plots and evaluation file) will be saved.
RESULTS_SAVE_DIR = os.path.join(DATA_DIR_HOME, 'kitti_results/')

# Where to store allen drive
ALLEN_DRIVE_PATH = os.path.join(DATA_DIR_HOME, 'allen-brain-observatory/visual-coding-2p/')
