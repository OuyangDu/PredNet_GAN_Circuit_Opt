...
data = {
    ...
    'res_shift_info': res_shift_info,
    'stim_shift_info': stim_shift_info,
    'res_size_info': res_size_info,
    'stim_size_info': stim_size_info,
    'res_square_part_info': res_square_part_info,
    'stim_square_part_info': stim_square_part_info,
